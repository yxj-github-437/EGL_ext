...
enum {
    ...
    /*
     * Returns 1 if the native window is valid, 0 otherwise. native window is
     * valid if it is safe (i.e. no crash will occur) to call any method on it.
     */
...
enum {
    ...
    /* transforms source by the inverse transform of the screen it is displayed
     * onto. This transform is applied last */
